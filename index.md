...
Она отменит все миграции, то есть удалит все таблицы из БД. Но иногда при применении миграций, может произойти сбой, и тогда миграции станут "грязными" и не завершаться.
Чтобы исправить эту проблему, нужно сначала установить CLI утилиту migrate:
...
```
Она удалит все таблицы в БД, удалит таблицу мигратора. 
После чего можно делать исправления в файлах миграций и пробовать снова их запускать.
